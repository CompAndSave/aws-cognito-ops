...
class Cognito {
  ...
  //
  static signOut(res, path = "/") {
    res.clearCookie("AWSCognito_accessToken", { path: path });
    res.clearCookie("AWSCognito_refreshToken", { path: path });
    res.clearCookie("AWSCognito_username", { path: path });
    return true;
  }
