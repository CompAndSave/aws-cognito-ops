...
class Cognito {
  /**
   * @class
   * @classdesc - Class for authentication via AWS Cognito and ExpressJS
   */
  constructor() {}

  /**
   * Static method to get Implicit Grant URL
   * 
  ...
  /**
   * Static method to get Authorization Code Grant URL
   * 
  ...
  /**
   * Static method to get the access token from server cookie
   * 
  ...
  /**
   * For Implict Grant - Static method to extract the accessToken from the callback url
   * 
   * @param {string} callbackToken postback token return from Cognito (Implict Grant flow)
   * @returns {string|boolean} return false if error or accessToken string
   */
  ...
  /**
   * For Authorization Code Grant - Static method to obtain accessToken and/or refreshToken from authorization code
   * 
   * @param {string} authorizationCode authorization code returned from Cognito (Authorization Code Grant flow)
   * @returns {promise} promise with token object
   */
  ...
  /**
   * Static method to get the accessToken / refreshToken via API
   * 
   * @param {string} username Username
   * @param {string} password Password
   * @param {boolean} [needRefreshToken=false] set true if refreshToken is needed, default is false
   * @returns {promise} promise with token or error object
   */
  ...
  /**
   * Static method to set token to cookies
   * 
  ...
  /**
   * Static method to check if having valid accessToken or refreshToken
   * 
   * @param {object} req ExpressJS request object
   * @param {object} res ExpressJS response object
   * @returns {promise} promise with accessToken string if success or false
   */
  ...
  /**
   * Static method to locally sign out by clearing token cookie
   * 
  ...
  /**
   * Static method to getSession by authenticated user
   * 
   * @param {object} cognitoUser Cognito User object
   * @returns {promise} promise with Cognito User object with session set
   */
  ...
  /**
   * Static method to globally signOut for authenticated session - refreshToken is invalidated, accessToken will work until they are expired
   * 
   * Reference: {@link https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_GlobalSignOut.html}
   * 
   * @param {string} username Username
   * @returns {promise} promise with boolean true if success or error object
   */
  ...
  /**
   * Static method to change password on authenticated session
   * 
   * @param {string} username Username
  ...
  /**
   * Static method of forgot Password flow for unauthenticated session
  ...
  /**
   * Static method to update password by using the verification code
   * 
   * @param {string} username Username
   * @param {string} newPassword New password
