...
class Cognito {
  ...
  // Global signOut - refreshToken is invalidated, accessToken will work until they are expired
  ...
  static async globalSignOut(username) {
    ...
    let error, cognitoUser = new AmazonCognitoIdentity.CognitoUser(userData);
